...
export default class ConfirmVisitReg extends Component {
  ...
  alert() {
    ...
    this.props.navigation.navigate('VisitDoctorReg');
  }
  alertback() {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
          ...
          <TouchableHighlight
            style={[styles.cardButton, styles.topRight]}
          ...
          <View style={styles.innercontainer}>
            ...
            <Text> {''}</Text>
            <Text> {''}</Text>
            <Text style={styles.paragraph}>Urgent visit </Text>
            <Text> {''}</Text>
            <Text> {''}</Text>
            <Text> {''}</Text>
            <Text> {''}</Text>
          ...
          <TouchableHighlight
            style={[styles.cardButton, styles.bottomLeft]}
            onPress={this.alertback.bind(this)}>
            <Image
